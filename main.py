...
from ML.noisy_dataset import noisy_dataset
...
class Ui_Main(QtWidgets.QDialog):
    def __init__(self):
        ...
        self.dataset5 = noisy_dataset(self.dataset1)  # Normalizasyon uygulanmış veri seti
        ...
        self.button4.clicked.connect(lambda: self.go_to_model_menu(self.dataset4, "Normalize Edilmiş Veriler"))
        self.button5.clicked.connect(lambda: self.go_to_model_menu(self.dataset5, "Gürültülü Veriler"))
